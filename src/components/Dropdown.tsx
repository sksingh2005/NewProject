...
export default function Dropdown({ buttonLabel, buttonIcon: Icon, options ,className}: any) {
  ...
  return (
    <div className={`relative`} ref={ref}>
      ...
      <motion.button
        ...
        onClick={() => setOpen((p) => !p)}
        className={`${className} flex items-center gap-2 bg-gray-900 dark:bg-gray-800 hover:bg-gray-800 dark:hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-medium transition-colors shadow-lg cursor-pointer`}
      >
        {Icon && <Icon size={20} />}
        {buttonLabel}
      </motion.button>
